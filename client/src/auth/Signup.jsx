...
import { UserPlus, Eye, EyeOff, Mail, Lock, User, Check, X } from 'lucide-react';
...
export default function Signup() {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-100 via-blue-50 to-indigo-100 overflow-hidden px-4">
      ...
      <div className="absolute top-20 right-1/4 w-14 h-7 bg-gradient-to-r from-emerald-300 to-teal-300 rounded-full blur-md opacity-50 animate-pulse" style={{ animationDelay: '2s' }} />
