        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            <div className="relative inline-block mb-6">
              {/* Glow effect */}
              <div className="absolute -inset-2 bg-gradient-to-r from-indigo-600 to-purple-600 rounded-full blur opacity-25" />
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300">Manage your personal information</p>
          </div>
          ...
          <div className="grid gap-6">
            ...
            {/* Stats Section */}
            <div className="bg-white/80 dark:bg-white/10 dark:border-gray-700 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-gray-100/50">
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-6">Activity Overview</h2>
              <div className="grid md:grid-cols-3 gap-4">
                <div className="text-center p-4 bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-indigo-800/20 dark:to-purple-800/20 rounded-xl">
                  <div className="text-2xl font-bold text-indigo-600 dark:text-indigo-400">24</div>
                  <div className="text-sm text-gray-600 dark:text-gray-300">Questions Asked</div>
                </div>
                <div className="text-center p-4 bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-800/20 dark:to-pink-800/20 rounded-xl">
                  <div className="text-2xl font-bold text-purple-600 dark:text-purple-400">156</div>
                  <div className="text-sm text-gray-600 dark:text-gray-300">Searches Made</div>
                </div>
                <div className="text-center p-4 bg-gradient-to-br from-pink-50 to-indigo-50 dark:from-pink-800/20 dark:to-indigo-800/20 rounded-xl">
